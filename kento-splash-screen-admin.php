...
?>
	...
	<tr valign="top">
		<th scope="row"><?php echo __('Use this Shortcode:');?>
		</th>
		<td style="vertical-align:middle;">
			<input  type="text" name="kento_splash_screen_shortcode" onClick="this.select();" size="auto" id="kento-splash-screen-shortcode"  value ="[kento-splash-screen]"  > <?php echo __('** Use this shortcode to display splash screen.');?>
...
<?php } ?>
	...
	<tr valign="top">
		<th scope="row"><?php echo __('Test Mode:');?>
		</th>
		<td style="vertical-align:middle;">
			<input type="checkbox" name="kento_splash_screen_demo" size="7" id="kento-splash-screen-demo"  value ="1" <?php if ( $kento_splash_screen_demo == 1 ) echo "checked"; ?> ><?php echo __('** Will popup for every refresh.');?>
...
<tr valign="top">
		<th scope="row"><?php echo __('Box Width:');?>
		</th>
		<td style="vertical-align:middle;">
...
<tr valign="top">
		<th scope="row"><?php echo __('Box Height:');?>
		</th>
		<td style="vertical-align:middle;">
...
<tr valign="top">
		<th scope="row"><?php echo __('Position Left(%):');?>
		</th>
		<td style="vertical-align:middle;">
			<input type="text" name="kento_splash_screen_left" size="7" id="kento-splash-screen-left"  value ="<?php if ( isset( $kento_splash_screen_left ) && !empty($kento_splash_screen_left) ) { echo $kento_splash_screen_left; } else { echo "30"; } ?>">% <?php echo __('(**If you increase/decrease box width then you must adjust position left value.)');?>
	...
	<tr valign="top">
		<th scope="row"><?php echo __('Background Color:');?>
		</th>
		<td style="vertical-align:middle;">
	...
	<tr valign="top">
		<th scope="row"><?php echo __('Background Image URL:');?>
		</th>
		<td style="vertical-align:middle;">
	...
	<tr valign="top">
		<th scope="row"><?php echo __('Border Size:');?>
		</th>
		<td style="vertical-align:middle;">
	...
	<tr valign="top">
		<th scope="row"><?php echo __('Border Color:');?>
		</th>
		<td style="vertical-align:middle;">
	...
	<tr valign="top">
		<th scope="row"><?php echo __('HTML Content:');?>
		</th>
		<td style="vertical-align:middle;">
